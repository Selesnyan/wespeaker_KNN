...
config=/mnt/matylda4/xpalka07/wespeaker/exp/vbx_16k/v2/conf/rn101pf_600frms_sgd_aam.yaml
#exp_dir=/exp/ResNet101-PF-emb256-fbank64-num_frms600-aug0.6-spTrue-saFalse-AAM-SGD-epoch150
#exp_dir="./exp/ResNet101-PF-emb256-fbank64-num_frms600-aug0.6-spTrue-saFalse-AAM-SGD-epoch150"
exp_dir="/mnt/matylda4/xpalka07/wespeaker/exp/vbx_16k/v2/exp/test_RN"
#exp_dir=/mnt/matylda4/xpalka07/wespeaker/exp/vbx_16k/v2/exp/ResNet101-PF-emb256-fbank64-num_frms600-aug0.6-spTrue-saFalse-AAM-SGD-epoch150
#/exp/resnet_test
...
#  exit
  torchrun --rdzv_backend=c10d --rdzv_endpoint=$(hostname):$[$RANDOM % 10000 + 20000] --nnodes=1 --nproc_per_node=$num_gpus \
    /mnt/matylda4/xpalka07/wespeaker/exp/vbx_16k/v2/wespeaker/bin/train.py --config $config \
      --exp_dir ${exp_dir} \
      --gpus "$gpus" \
      --num_avg ${num_avg} \
      --data_type "${data_type}" \
      --train_data ${data}/vox_cn1/${data_type}.list \
      --train_label ${data}/vox_cn1/utt2spk \
