...
import wespeaker.dataset.processor_sc as processor
...
def Dataset(data_type,
    ...
    if data_type == 'feat':
        ...
        # speed perturb
        speed_perturb_flag = True # False #configs.get('speed_perturb', True)
        ...
        ## get labels from RTTM
        dataset = Processor(dataset, processor.get_labels, rttm_dict, spk2id_dict,
                            configs.get('num_frms', 200), chunk_len / 16000 * 100)
